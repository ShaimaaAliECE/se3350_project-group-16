...
>>>>>>> 36fb70ccbe760026db40a3e4ab96f789f0fe9555
    ...
    while (left.length && right.length) {
      if (left[0] < right[0]) {
        let mergeStep3 =
          ...
          " push " +
          left[0] +
          " into sorted array first. Shift left array index one element to the left.";
        ...
        let mergeStep3 =
          ...
          " push " +
          right[0] +
          " into sorted array first. Shift right array index one element to the left.";
    ...
    if (!left.length) {
      let mergeStep4 =
        "Left array has no more element to compare. Return sorted array with remaining right elements appended.";

      holder.push(mergeStep4);
      data.push([...sorted, ...left, ...right]);
    } else if (!right.length) {
      let mergeStep4 =
        "Right array has no more elements to compare. Return sorted array with remaining elements in left array appended.";
